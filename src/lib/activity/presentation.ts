...
> = {
  ...
  "invoice.credit_requested": { label: "Initiated Stripe credit", icon: CreditCard, tone: "info" },
  "invoice.credited": { label: "Applied credit", icon: CreditCard, tone: "info" },
  "invoice.void_requested": { label: "Initiated Stripe void", icon: XCircle, tone: "info" },
